...
public class FloorSand extends Floor {

    public FloorSand(String id, String texturePath) {
    ...
    public void render(Renderer renderer, World world, Vector2 displayPosition, BlockPosition blockPosition, Color color) {
        ...
        renderer.addWorldViewable(new Viewable(mainTexture, new Box(floorValue * 16, 0, 16, 16), displayPosition, 2, color));
    }
}
